...
| 配置项 | 必填 | 默认值 | 说明 |
|:-----:|:----:|:----:|:----:|
| TEMPLATES_DRAW__GEMINI_API_URL | 是 | https://generativelanguage.googleapis.com/v1beta/openai/ | Gemini API Url 默认为官方完整 Url，可以替换为中转 https://xxxxx.xxx/v1beta
